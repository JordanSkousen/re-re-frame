...
(defn dispatch [& args] (apply dispatch args))
(defn dispatch-sync [& args] (apply dispatch-sync args))
(defn reg-event-ctx [& args] (apply reg-event-ctx args))
(defn clear-event [& args] (apply clear-event args))
(defn subscribe [& args] (apply subscribe args))
(defn clear-sub [& args] (apply clear-sub args))
(defn clear-subscription-cache! [& args] (apply clear-subscription-cache! args))
(defn reg-fx [& args] (apply reg-fx args))
(defn clear-fx [& args] (apply clear-fx args))
(defn reg-cofx [& args] (apply reg-cofx args))
(defn inject-cofx [& args] (apply inject-cofx args))
(defn clear-cofx [& args] (apply clear-cofx args))
(defn path [& args] (apply path args))
(defn enrich [& args] (apply enrich args))
(defn after [& args] (apply after args))
(defn on-changes [& args] (apply on-changes args))
(defn my-f [& args] (apply my-f args))
(defn reg-global-interceptor [& args] (apply reg-global-interceptor args))
(defn clear-global-interceptor [& args] (apply clear-global-interceptor args))
(defn ->interceptor [& args] (apply ->interceptor args))
(defn get-coeffect [& args] (apply get-coeffect args))
(defn assoc-coeffect [& args] (apply assoc-coeffect args))
(defn get-effect [& args] (apply get-effect args))
(defn assoc-effect [& args] (apply assoc-effect args))
(defn enqueue [& args] (apply enqueue args))
(defn set-loggers! [& args] (apply set-loggers! args))
(defn my-logger [& args] (apply my-logger args))
(defn console [& args] (apply console args))
(defn make-restore-fn [& args] (apply make-restore-fn args))
(defn purge-event-queue [& args] (apply purge-event-queue args))
(defn add-post-event-callback [& args] (apply add-post-event-callback args))
(defn remove-post-event-callback [& args] (apply remove-post-event-callback args))